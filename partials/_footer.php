<?php
    echo '<footer class="flex flex-col justify-between fixed-bottom items-center px-6 py-2 bg-gray-800 sm:flex-row">
       
        
        <p class="py-2 text-gray-100 sm:py-0">© 2020 Copyright | All rights reserved</p>
