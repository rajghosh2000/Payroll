    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="singupModalLabel">New User</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="/Payroll/partials/_addEmpl.php" method="post">
                <div class="modal-body">
                    <div
                        ...
                        <select class="bg-white rounded border text-dark border-gray-900 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 mb-4" name="e_pos" id="e_pos">
